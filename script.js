...
nav.classList.add("container-fluid","bg-primary","text-center")
...
con.classList.add("container","bg-secondary","mt-0")
...
async function weather(){
    ...
    data.forEach(ele => {
        ...
        ndiv.classList.add("bg-dark","text-white","text-center","cname")
